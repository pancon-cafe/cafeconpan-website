...
const STRINGS = {
  en: {
    ...
    contact:{
      ...
      info:[{label:"Email",val:"hello@pancon.cafe",href:"mailto:hello@pancon.cafe"},{label:"Phone",val:"1-833-724-CAFE (1-833-724-2233)",href:"tel:+18337242233"},{label:"Response Time",val:"Within 24 Hours"},{label:"Business",val:"Cafe Con Pan LLC"},{label:"Services",val:"Tech · Coffee · Culture · Community"}],
      nameLabel:"Your Name", namePlaceholder:"Full name",
    ...
    footer:{ tagline:"Tech · Coffee · Culture · Community", copy:"© 2026 Cafe Con Pan LLC", disclaimer:"We provide guidance and implementation support — not legal, tax, or financial advice. For those needs, we recommend working with a licensed professional." },
  ...
  es: {
    ...
    contact:{
      ...
      info:[{label:"Correo",val:"hello@pancon.cafe",href:"mailto:hello@pancon.cafe"},{label:"Teléfono",val:"1-833-724-CAFE (1-833-724-2233)",href:"tel:+18337242233"},{label:"Tiempo de Respuesta",val:"Dentro de 24 Horas"},{label:"Negocio",val:"Cafe Con Pan LLC"},{label:"Servicios",val:"Tech · Café · Cultura · Comunidad"}],
      nameLabel:"Tu Nombre", namePlaceholder:"Nombre completo",
    ...
    footer:{ tagline:"Tech · Café · Cultura · Comunidad", copy:"© 2026 Cafe Con Pan LLC", disclaimer:"Ofrecemos orientación y apoyo operativo — no asesoría legal, fiscal ni financiera. Para esas necesidades, recomendamos trabajar con un profesional licenciado." },
